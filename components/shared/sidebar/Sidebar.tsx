        ...
        return (
          ...
          >
            <Image
              ...
              width={20}
              height={20}
              className={isActive ? "invert" : "invert-0 dark:invert"}
            />
            <p
              className={`${
...
const LeftSidebar = () => {
  return (
    <section className="custom-scrollbar background-light900_dark200 light-border sticky left-0 top-0 mt-28 flex h-[100vh-112px] w-fit flex-col justify-between overflow-y-auto rounded-xl border-r p-6 shadow-light-300 dark:shadow-none max-sm:hidden lg:w-[266px]">
      <SideBarContent />
      <SignedOut>
        <div className="flex flex-col gap-3">
          <Link href="/sign-in">
            <Button className="small-medium btn-secondary w-full rounded-lg px-4 py-3">
              ...
              />
              <span className="invert-0 dark:invert max-lg:hidden">
                Log In
              </span>
            </Button>
          </Link>
